## PRODUCT CIRCULAR ECONOMY TRACKING & ReSOLVE RECOMMENDER MANAGEMENT SYSTEM - CCTV or LIVE IMAGE MONITORING
## Circular Product/ Asset Material Classification through CCTV/ Live Image Monitoring
## and Deep Learning Model Image Material Recognition Model 
## Output Recognition Models will feed to Product/ Asset Circular Tracking and ReSOLVE Recommender Management System
## Further Data Validation Insight will passed through Off Chain Cross Verification and Validation Smart Contract
## The Result Insight will shown Product Tracking Information, ReSOLVE Framework Recommendation, and Supported Circular Supply Chain 
